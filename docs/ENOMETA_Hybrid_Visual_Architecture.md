...
> **last_updated**: 2026-03-02 — v8 + 글쓰기 v11 + script_data v2 (VERB 101/EMOTION 68/SCIENCE 85 + custom_dictionary + 미등록 단어 감지)
...
- **WaveformLayer**: FFT 요약이 아닌 실제 오디오 샘플값을 사용한 파형 렌더링
- **ParticleLayer**: numpy 벡터 연산으로 파티클 시뮬레이션 (오디오 에너지가 물리에 직접 작용)
